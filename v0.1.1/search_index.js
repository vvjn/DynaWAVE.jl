...

{
    ...
    "category": "section",
    "text": "Julia 0.6 needs to be installed prior to using DynaWAVE. After starting a command-line terminal (in Linux, Windows, or OS X), DynaWAVE can then be installed by navigating to the base directory of this software and running the single command julia install_dynawave.jl."
},
